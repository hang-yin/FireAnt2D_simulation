...
# define adhearence function
# when two particles touch each other, they will stick together
def adhearence(p1, p2):
    dx = p1.x - p2.x
    dy = p1.y - p2.y
...
# return whether two particles overlap
# if they overlap, make them bounce, i.e. update their angle, speed and position 
def collide(p1, p2):
