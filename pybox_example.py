...
pygame.display.set_caption('Combining Box2D & Pygame')
...
ground_body = world.CreateStaticBody(
    position=(0, 0),
    shapes=polygonShape(box=(60, 1)),
)

bridge_left = world.CreateStaticBody(
    position=(0, 0),
    shapes=polygonShape(box=(10, 20)),
)

bridge_right = world.CreateStaticBody(
    position=(60, 0),
    shapes=polygonShape(box=(10, 20)),
)
